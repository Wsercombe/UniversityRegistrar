    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Registrar", x => x.RegistrarId);
                    table.ForeignKey(
                        name: "FK_Registrar_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Registrar_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registrar_CourseId",
                table: "Registrar",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Registrar_StudentId",
                table: "Registrar",
                column: "StudentId");
        }
